                ...
                btnPath.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                java.awt.Window parent = javax.swing.SwingUtilities
                                                .getWindowAncestor(PanelImportExportDialog.this);
                                java.awt.FileDialog fd;
                                String title = PanelImportExportDialog.this.importing ? "Import Data" : "Export Data";
                                int mode = PanelImportExportDialog.this.importing ? java.awt.FileDialog.LOAD
                                                : java.awt.FileDialog.SAVE;

                                if (parent instanceof java.awt.Frame) {
                                        fd = new java.awt.FileDialog((java.awt.Frame) parent, title, mode);
                                } else if (parent instanceof java.awt.Dialog) {
                                        fd = new java.awt.FileDialog((java.awt.Dialog) parent, title, mode);
                                } else {
                                        fd = new java.awt.FileDialog((java.awt.Frame) null, title, mode);
                                }
                                fd.setFile("*.etd");
                                fd.setDirectory(!Strings.isNullOrEmpty(txtPath.getText()) ? txtPath.getText().trim()
                                                : (System.getProperty("user.dir")
                                                                + (!PanelImportExportDialog.this.importing
                                                                                ? File.separator + "externalTweaker.etd"
                                                                                : "")));
                                fd.setVisible(true);
                                                                ...
                                                                groupLayout.createSequentialGroup()
                                                                                .addGroup(groupLayout
                                                                                                ...
                                                                                                .addGroup(groupLayout
                                                                                                                ...
                                                                                                                .addComponent(chkRecipes,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                Short.MAX_VALUE)
                                                                                                                .addPreferredGap(
                                                                                                                                ComponentPlacement.RELATED)
                                                                                                                .addComponent(chkItems,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                57,
                                                                                                                                Short.MAX_VALUE)
                                                                                                                .addPreferredGap(
                                                                                                                                ComponentPlacement.RELATED)
                                                                                                                .addComponent(chkFluids,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                58,
                                                                                                                                Short.MAX_VALUE)
                                                                                                                .addPreferredGap(
                                                                                                                                ComponentPlacement.RELATED)
                                                                                                                .addComponent(chkOreDict,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                71,
                                                                                                                                Short.MAX_VALUE))
                                                                                                .addGroup(groupLayout
